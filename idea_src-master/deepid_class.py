...
if __name__ == '__main__':
    ...
    test = '/home/rahul/Desktop/FInal/Vector/test'
    train = '/home/rahul/Desktop/FInal/Vector/train'
    param = '/home/rahul/Desktop/FInal/param/1-1400.txt'
    simple_deepid(learning_rate=0.01, n_epochs=40, dataset=(test, train), params_file=param, nkerns=[20,40,60,80], batch_size=5, n_hidden=160, n_out=1595, acti_func=relu)
    end = time.ctime()
